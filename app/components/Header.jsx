...
//   return (
//     <section className="w-full relative py-20 md:py-24 px-[3%] md:px-[10%] lg:px-[10%] overflow-hidden">
...
//             {/* Description */}
//             <p
//               className="text-md md:text-lg leading-relaxed text-gray-700 dark:text-gray-300 px-4 mx-auto text-center"
//             >
...
//             {/* CTA Buttons */}
//             <div className="mt-6 md:mt-8 flex flex-col sm:flex-row items-center gap-5 justify-center">
//               <a
//                 href="#contact"
...
//                   whileHover="hover"
//                   whileTap="tap"
//                   className="text-gray-500 mt-4 lg:mt-4 dark:text-gray-400 transition-colors
